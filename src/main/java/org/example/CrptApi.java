...
public class CrptApi {
    ...
    public CrptApi(TimeUnit timeUnit, int requestLimit) {
        ...
        if (requestLimit >= 0) {
            ...
            throw new IllegalArgumentException("Это отрицательное число -> не верные параметры!");
        }
    }
    ...
    JSONObject getDocJson(Document document, String signature) {
    ...
    private void httpRequest(String json) {
        ...
        try {
            ...
            String URL = "http://<server-name>[:server-port]" +
...
//            CrptApi api = new CrptApi(TimeUnit.MINUTE, 0);
